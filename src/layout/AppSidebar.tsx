...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Gestion",
    subItems: [
      { name: "Categorias", path: "/gestion/categorias", pro: false },
    ],
  },
    {
    name: "Formulario",
    ...
    >
      ...
      >
        <Link to="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <div className="w-32">
              <img src="https://app.quar.com.co/assets/img/logo.png" alt="" />
            </div>
          ) : (
            <div className="w-10">
              <img
                src="https://app.quar.com.co/favicon.ico"
                alt="Logo"
              />
            </div>
          )}
